...
namespace Drupal\reserver_now\Plugin\Block;

use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\reserver_now\Plugin\Config\Block\ReserverNowBlockClass;
...
/**
 * Provides a 'ReserverNowBlock' block.
 *
 * @Block(
 *  id = "reserver_now_course",
 *  admin_label = @Translation("Reservar curso"),
 * )
 */
class ReserverNowBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\reserver_now\Plugin\Config\Block\ReserverNowBlockClass
     */
     ...
     * @param \Drupal\reserver_now\Plugin\Config\Block\ReserverNowBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, ReserverNowBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('reserver_now.course')
        );
    }
