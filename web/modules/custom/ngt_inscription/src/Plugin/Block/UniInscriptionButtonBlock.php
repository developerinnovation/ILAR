...
use Drupal\ngt_inscription\Plugin\Config\Block\UniInscriptionButtonBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Provides a 'UniInscriptionButtonBlock' block.
 *
 * @Block(
 *  id = "ngt_inscription_inscription_button",
 *  admin_label = @Translation("NGT Botón de desinscriptión a cursos"),
 * )
 */
class UniInscriptionButtonBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_inscription\Plugin\Config\Block\UniInscriptionButtonBlockClass
     */
     ...
     * @param \Drupal\ngt_inscription\Plugin\Config\Block\UniInscriptionButtonBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, UniInscriptionButtonBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_inscription.UniInscriptionButton')
        );
    }
