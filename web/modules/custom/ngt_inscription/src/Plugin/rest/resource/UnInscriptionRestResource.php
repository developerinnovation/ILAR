 ...
 *
 * @RestResource(
 *   id = "uninscription_course_rest_resource",
 *   label = @Translation("Uninscription to course"),
 *   uri_paths = {
 *     "canonical" = "/ngt/api/v1/uninscription/reserve",
 *   }
 * )
 */
class InscriptionRestResource extends ResourceBase { 
    ...
    public function deleted(array $params) {
        return \Drupal::service('ngt_inscription.uninscription_rest')->deleted($this->currentUser, $params);
    }
