...
namespace Drupal\notification\Plugin\Config\Form;
...
class notificationSettingsFormClass {
    ...
    public function getFormId(){
        return 'notification_settings_form';
    }
    ...
    public function setFileAsPermanent($fid) {
        ...
        $file->setPermanent();
        $file->save();
        \Drupal::service('file.usage')->add($file, 'notification', 'notification', $fid);
    }
    ...
    public function submitForm(array &$form, FormStateInterface $form_state){
        ...
        $config = \Drupal::configFactory()->getEditable('notification.settings');
        $config
    ...
    public function buildForm(array $form, FormStateInterface $form_state){
        $config = \Drupal::config('notification.settings');
