...
use Drupal\ngt_general\Plugin\Config\Block\NodeTopLessonBlockClass;
...
/**
 * Provides a 'NodeTopLessonBlock' block.
 *
 * @Block(
 *  id = "ngt_general_node_top_lesson",
 *  admin_label = @Translation("Ngt general Node lesson top"),
 * )
 */
class NodeTopLessonBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\NodeTopLessonBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\NodeTopLessonBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeTopLessonBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.node_top_lesson')
        );
    }
