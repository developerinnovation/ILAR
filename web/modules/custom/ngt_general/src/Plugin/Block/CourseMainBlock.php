...
/**
 * Provides a 'CourseMainBlock' block.
 *
 * @Block(
 *  id = "ngt_general_course_main",
 *  admin_label = @Translation("Ngt general Curso Princial"),
 * )
 */
class CourseMainBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\CourseMainBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\CourseMainBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, CourseMainBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.course_main')
        );
    }
