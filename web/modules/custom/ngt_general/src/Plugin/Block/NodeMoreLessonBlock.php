...
use Drupal\ngt_general\Plugin\Config\Block\NodeMoreLessonBlockClass;
...
/**
 * Provides a 'NodeMoreLessonBlock' block.
 *
 * @Block(
 *  id = "ngt_general_node_more_lesson",
 *  admin_label = @Translation("Ngt general Node lesson more"),
 * )
 */
class NodeMoreLessonBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\NodeMoreLessonBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\NodeMoreLessonBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeMoreLessonBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.node_more_lesson')
        );
    }
