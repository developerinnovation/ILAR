...
use Drupal\ngt_general\Plugin\Config\Block\NodeRightCourseBlockClass;
...
/**
 * Provides a 'NodeRightCourseBlock' block.
 *
 * @Block(
 *  id = "ngt_general_node_right_course",
 *  admin_label = @Translation("Ngt general Node course right"),
 * )
 */
class NodeRightCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_general\Plugin\Config\Block\NodeRightCourseBlockClass
     */
     ...
     * @param \Drupal\ngt_general\Plugin\Config\Block\NodeRightCourseBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeRightCourseBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_general.node_right_course')
        );
    }
