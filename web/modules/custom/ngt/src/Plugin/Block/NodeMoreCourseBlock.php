...
use Drupal\ngt\Plugin\Config\Block\NodeMoreCourseBlockClass;
...
/**
 * Provides a 'NodeMoreCourseBlock' block.
 *
 * @Block(
 *  id = "ngt_node_more_course",
 *  admin_label = @Translation("ngt Node course more"),
 * )
 */
class NodeMoreCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt\Plugin\Config\Block\NodeMoreCourseBlockClass
     */
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\NodeMoreCourseBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeMoreCourseBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.node_more_course')
        );
    }
