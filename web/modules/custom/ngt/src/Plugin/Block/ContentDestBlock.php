...
use Drupal\ngt\Plugin\Config\Block\ContentDestBlockClass;
...
/**
 * Provides a 'ContentDestBlock' block.
 *
 * @Block(
 *  id = "ngt_contenido_destacado",
 *  admin_label = @Translation("ngt Contenido destacado"),
 * )
 */
class ContentDestBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt\Plugin\Config\Block\ContentDestBlockClass
     */
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\ContentDestBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, ContentDestBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.content_dest')
        );
    }
