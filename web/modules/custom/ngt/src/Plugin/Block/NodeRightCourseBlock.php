...
use Drupal\ngt\Plugin\Config\Block\NodeRightCourseBlockClass;
 ...
 *
 * @Block(
 *  id = "ngt_node_right_course",
 *  admin_label = @Translation("ngt Node course right"),
 * )
 */
class NodeRightCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\NodeRightCourseBlockClass $configurationInstance
     */
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.node_right_course')
        );
    }
