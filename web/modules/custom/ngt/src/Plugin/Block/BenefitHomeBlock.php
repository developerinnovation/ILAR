...
use Drupal\ngt\Plugin\Config\Block\BenefitHomeBlockClass;
...
/**
 * Provides a 'BenefitHomeBlock' block.
 *
 * @Block(
 *  id = "ngt_benefit_home",
 *  admin_label = @Translation("ngt Beneficio en Home"),
 * )
 */
class BenefitHomeBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt\Plugin\Config\Block\BenefitHomeBlockClass
     */
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\BenefitHomeBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, BenefitHomeBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.benefit_home')
        );
    }
