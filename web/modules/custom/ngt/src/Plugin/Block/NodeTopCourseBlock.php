...
use Drupal\ngt\Plugin\Config\Block\NodeTopCourseBlockClass;
...
/**
 * Provides a 'NodeTopCourseBlock' block.
 *
 * @Block(
 *  id = "ngt_node_top_course",
 *  admin_label = @Translation("ngt Node course top"),
 * )
 */
class NodeTopCourseBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\NodeTopCourseBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, NodeTopCourseBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.node_top_course')
        );
    }
