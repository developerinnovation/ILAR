...
use Drupal\ngt\Plugin\Config\Block\CourseCategoryBlockClass;
...
/**
 * Provides a 'CourseCategoryBlock' block.
 *
 * @Block(
 *  id = "ngt_course_category",
 *  admin_label = @Translation("ngt Curso por categorías"),
 * )
 */
class CourseCategoryBlock extends BlockBase implements ContainerFactoryPluginInterface{
     ...
     * @param \Drupal\ngt\Plugin\Config\Block\CourseCategoryBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, CourseCategoryBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt.course_category')
        );
    }
